...
if __name__ == '__main__':
	...
	apply_commands('multi-path-routing', 'external_switch/external-switch', '9090', 'external-switch-commands-s1.txt')
	print('\nCOMMAND #2 - THRIFT 9091')
	apply_commands('multi-path-routing', 'inner_switch/inner-switch', '9091', 'inner-switch-commands-s2.txt')
	print('\nCOMMAND #3 - THRIFT 9092')
	apply_commands('multi-path-routing', 'inner_switch/inner-switch', '9092', 'inner-switch-commands-s3.txt')
	print('\nCOMMAND #4 - THRIFT 9093')
	apply_commands('multi-path-routing', 'external_switch/external-switch', '9093', 'external-switch-commands-s4.txt')