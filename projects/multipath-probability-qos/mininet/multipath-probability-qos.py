...
class ProbabilisticMultipathTopo(Topo):
    ...
    def add_switches(self, sw_path, thrift_port, pcap_dump, **opts):
        ...
        self.networkSwitches.extend((
            self.addSwitch('s1', sw_path = sw_path, json_path = 'build/multipath-probability-qos.json', thrift_port = 9090, pcap_dump = pcap_dump),
            self.addSwitch('s2', sw_path = sw_path, json_path = 'build/multipath-probability-qos.json', thrift_port = 9091, pcap_dump = pcap_dump),
            self.addSwitch('s3', sw_path = sw_path, json_path = 'build/multipath-probability-qos.json', thrift_port = 9092, pcap_dump = pcap_dump),
            self.addSwitch('s4', sw_path = sw_path, json_path = 'build/multipath-probability-qos.json', thrift_port = 9093, pcap_dump = pcap_dump),
            self.addSwitch('s5', sw_path = sw_path, json_path = 'build/multipath-probability-qos.json', thrift_port = 9094, pcap_dump = pcap_dump)
        ))
